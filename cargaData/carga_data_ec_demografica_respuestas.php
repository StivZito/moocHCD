		...
		if ($file && move_uploaded_file($_FILES['archivo']['tmp_name'],"uploads/".$file))
		{
			...
			{	
				...
				foreach ( $xlsx->rows() as $k => $r ) 
				{
					...
					if ($tipoEstudiante !== '') {
						guardarRespuestasEncuestaDemografica($numPregunta,$numRespuesta,$pregunta,$literal,$codigo_a,$opcion_a,$codigo_b,$opcion_b,$codigo_c,$opcion_c,$codigo_d,$opcion_d,$codigo_e,$opcion_e,$codigo_f,$opcion_f,$termino,$anio,$sistema,$tipo,$tipoEstudiante);

					} 

					if ($tipoEstudiante == '') {
						guardarRespuestasEncuestaDemografica($numPregunta,$numRespuesta,$pregunta,$literal,$codigo_a,$opcion_a,$codigo_b,$opcion_b,$codigo_c,$opcion_c,$codigo_d,$opcion_d,$codigo_e,$opcion_e,$codigo_f,$opcion_f,$termino,$anio,$sistema,$tipo,'ADMISION');
						guardarRespuestasEncuestaDemografica($numPregunta,$numRespuesta,$pregunta,$literal,$codigo_a,$opcion_a,$codigo_b,$opcion_b,$codigo_c,$opcion_c,$codigo_d,$opcion_d,$codigo_e,$opcion_e,$codigo_f,$opcion_f,$termino,$anio,$sistema,$tipo,'ESPOL');
					}			
				} 
			} else {
