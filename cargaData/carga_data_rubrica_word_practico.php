		...
		if ($file && move_uploaded_file($_FILES['archivo']['tmp_name'],"uploads/".$file))
		{
			...
			{	
				...
				foreach ( $xlsx->rows() as $k => $r ) 
				{
					...
					if ($cedula !==''){
						guardarDatosRubricaWordPractico($id,$estudiante,$cedula,$p1,$p2,$p3,$p4,$p5,$p6,$p7,$p8,$p9,$p10,$p11,$p12,$p13,$p14,$p15,$p16,$p17,$calificacion,$termino,$anio,$sistema,$adminEspol,$franja,$paralelo,$docente);			
					}
