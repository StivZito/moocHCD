			...
			{	
				...
				foreach ( $xlsx->rows() as $k => $r ) 
				{
					...
					for ( $i = 0; $i < $cols; $i ++ ) 
					{
						...
						guardarDatosRubricaExcelPractico($name,$idEstudiante,$sis_id,$section,$enviado,$p1,$c1,$p2,$c2,$p3,$c3,$p4,$c4,$p5,$c5,$p6,$c6,$p7,$c7,$p8,$c8,$p9,$c9,$p10,$c10,$p11,$c11,$p12,$c12,$p13,$c13,$p14,$c14,$p15,$c15,$intento,$correcto,$incorrecto,$calificacion,$termino,$anio,$sistema,$adminEspol,$franja,$paralelo,$docente);			
				} 
			} else {
