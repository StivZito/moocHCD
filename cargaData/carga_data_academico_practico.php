			...
			{	
				...
				foreach ( $xlsx->rows() as $k => $r ) 
				{
					...
					for ( $i = 0; $i < $cols; $i ++ ) 
					{
						...
						guardarDatosAcademicoPractico($matricula,$identificacion,$nombres,$apellidos,$email,$sexo,$fecha_nac,$edad,$estado_civil,$colegio,$tipo_colegio,$notaTeorico,$notaWord,$notaExcel,$notaPpt,$numVeces,$carrera,$termino,$anio,$sistema,$tipoEstudiante,$cohorte,$fechaExamen);	
				} 
			} else {
