...
switch ($_GET["tipo_grafico"])
{
    ...
    case '6':
        $consulta = query6($termino);

        $condicion3N = "sexo";
        $valor1 = "FEMENINO";
        $valor2 = "MASCULINO";

        $condicion4N = "tipo_colegio";
        $valor4_1 = "Particular";
        $valor4_2 = "Fiscomisional";
    break;
		
	 case '8':
        $consulta = query8($termino);
...
foreach ($arrayF as $key => $value)
{
    ...
    $drilldowmF_3N .= ' "' . $key . '" :{
                        ...
                        data: [
                                ["' . $valor1 . '", ' . $value[$valor1 . "_" . $valor4_1] . '],
                                ["' . $valor2 . '", ' . $value[$valor2 . "_" . $valor4_1] . ']
                            ]
                        },
                        "' . $key . '2" :{
                            name: "' . $valor4_2 . '",
                            ...
                            data: [
                                    ...
                                    ["' . $valor1 . '",' . $value[$valor1 . "_" . $valor4_2] . '],
                                    ["' . $valor2 . '",' . $value[$valor2 . "_" . $valor4_2] . ']
                                ]
                            },';
}
...
<script>
    ...
    var chart = new Highcharts.chart({
          ...
          subtitle: {
              text: 'Notas Ausentismo Examen Practico</a>'
          },
